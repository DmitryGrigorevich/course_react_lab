...
#### Проверка выполнения лабораторных работ (очный вариант)

Для проверки выполнения лабораторных работ используется расширение для VS Code [Examenator](https://marketplace.visualstudio.com/items?itemName=AltmanEA.examenator). 
